package com.rikkei.rxjavanetwordretrofit.view;
...
import com.rikkei.rxjavanetwordretrofit.R;
import com.rikkei.rxjavanetwordretrofit.network.ApiClient;
import com.rikkei.rxjavanetwordretrofit.network.model.ApiService;
import com.rikkei.rxjavanetwordretrofit.network.model.Note;
import com.rikkei.rxjavanetwordretrofit.network.model.User;
import com.rikkei.rxjavanetwordretrofit.util.MyDividerItemDecoration;
import com.rikkei.rxjavanetwordretrofit.util.PrefUtils;
import com.rikkei.rxjavanetwordretrofit.util.RecyclerTouchListener;
                ...
                apiService.fetchAllNotes()
                        ...
                        .subscribe(
                                new Consumer<List<Note>>() {
                                    @Override
                                    public void accept(List<Note> noteList) {
                                        notesList.clear();
